...
function populateForm(user) {
    ...
    document.getElementById('recentBooks').value = user.recentBooks.join(', ') || '';
}
...
async function addUser() {
    const user = {
        ...
        recentBooks: document.getElementById('newUserRecentBooks').value.split(',').map(book => book.trim())
    };
...
async function updateUser() {
    ...
    const user = {
        ...
        recentBooks: document.getElementById('recentBooks').value.split(',').map(book => book.trim())
    };
